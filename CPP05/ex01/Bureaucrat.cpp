...
/*   Updated: 2021/05/03 13:49:38 by mspinnet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (this->_grade <= _form.getGradeToSign())
		_form.beSigned(*this);
	else
		std::cout << "Bureaucrat " << this->_name << " cannot sign " << _form.getName() << " because grade to low!" << std::endl;
}
