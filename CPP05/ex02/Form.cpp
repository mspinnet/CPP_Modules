...
/*   Updated: 2021/05/03 16:52:27 by mspinnet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string const &name, int const grade_to_sign, int const grade_to_execute, std::string const &target) : _name(name), _grade_to_sign(grade_to_sign), _grade_to_execute(grade_to_execute), _target(target)
{
